...
abstract class MainColors {
  ...
  static const Color kYellowColor = Color(0xFFFFC700);
  static const Color kOrangeColor = Color(0xFFFFA800);
  static const Color kBlueColor = Color(0xFF0D72FF);
  static const Color kGreyColor = Color(0xFF828796);
